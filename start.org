...
#+TITLE: Emacs 24 configuration for Hunter Stewart
#+AUTHOR: Hunter Stewart
#+EMAIL: hunterdesu@gmail.com
...
#+BEGIN_SRC emacs-lisp
    (setq user-full-name "Hunter Stewart")
    (setq user-mail-address "hetre85@gmail.com")
#+END_SRC
...
#+END_SRC
  ...
  Don't create lock files. I don't want to just gitgnore this right now so I 
  am adding it here. Maybe one day I'll want lock file but not right now.
#+BEING_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; now you can type robe-start and get company-robe intellisense
  (global-company-mode t)
  (push 'company-robe company-backends)

  ;; Automatically activate the right rvm gemset and ruby version
  (defadvice inf-ruby-console-auto (before activate-rvm-for-robe activate)
    (rvm-activate-corresponding-ruby))

  ;; Use rainbows in all programming modes
